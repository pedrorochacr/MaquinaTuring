...
def run_turing_machine(palavra):
    global listTrilhas
    global cabecote
        ...
        for transicao in transicoes: 
            if transicao[0] == maquinaEstados:
                ...
                for i in range(len(listTrilhas)):
                    # print(listTrilhas[i], transicao)
                    # print(listTrilhas[i][cabecote], transicao[i+1], "\n")
...
def main():
    ...
    try:
        ...
        result = run_turing_machine(argumento[2])
